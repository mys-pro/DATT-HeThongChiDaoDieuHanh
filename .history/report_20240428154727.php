                ...
                <div class="content w-100 px-2 overflow-hidden">
                    ...
                    <div class="row g-0">
                        <div class="col">
                            ...
                            <!-- <object data="./pdf.php#toolbar=100%" type="application/pdf" width="100%" height="720px"></object> -->
                            <iframe src="http://localhost/DATT-HeThongChiDaoDieuHanh/pdf.php" width="100%" height="760px"></iframe>
                        </div>
                    </div>
                </div>
            </div>
