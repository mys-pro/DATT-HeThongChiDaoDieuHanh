$(document).ready(function () {
    ...
    $('.sidebar__dropdown-item > a').click(function (event){
        ...
        var url = $(this).attr("href"); // Lấy URL hiện tại của thẻ a
        var param = "newParam=value"; // Tham số muốn thêm vào URL
        var separator = url.includes('?') ? '&' : '?'; // Xác định dấu "?" hoặc "&"

        // Tạo URL mới với tham số được thêm vào
        var newUrl = url + separator + param;
