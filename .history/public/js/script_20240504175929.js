$(document).ready(function () {
    ...
    $(document).click(function(event){
        ...
        // Kiểm tra nếu click không phải là trên phần tử #toggleButton hoặc #elementToHide
        if(!$target.closest('#dropdown-apps').length && !$target.closest('#elementToHide').length) {
            $("#elementToHide").hide();
        }
    });
