$(document).ready(function () {
    ...
    $('.sidebar__content-item > a[data-bs-toggle="collapse"]').mouseenter(function(){ 
        if(!$('#sidebarToggleExternalContent').hasClass('show'))
            $('#sidebarToggleExternalContent').collapse('show');
    }).mouseleave(function(){
        console.log("Rời khỏi box");
        // Thêm code xử lý khi rời khỏi hover vào đây
    });
