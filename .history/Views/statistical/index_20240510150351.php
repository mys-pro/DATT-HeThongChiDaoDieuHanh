<div class="content w-100 px-2 overflow-hidden">
    <span class="text-black fs-5 p-3 ps-0 d-inline-block fw-semibold"><?= $pageTitle ?></span>
    <div class="row g-0">
        <div class="col d-flex">
            <ul class="filter-list list-unstyled m-0 py-2 d-flex position-relative">
            ...
            <button id="btn-filter-statistical" type="button" class="btn btn-primary btn-filter my-2">Áp dụng</button>
        </div>
    </div>

    <div class="row g-0">
        <div class="col">
            <canvas id="barChart" class="bg-white p-4 rounded-3 shadow-sm"></canvas>
        </div>
    </div>
    ...
    <div class="row row-cols-xl-4 row-cols-md-3 row-cols-sm-2 row-cols-1 py-2 g-2">
        ...
        ?>
            <div class="col">
                <canvas id="doughnutChart<?= $count ?>" class="bg-white p-2 rounded-3 shadow-sm w-100 h-100"></canvas>
            </div>
        <?php endforeach; ?>
    </div>
</div>