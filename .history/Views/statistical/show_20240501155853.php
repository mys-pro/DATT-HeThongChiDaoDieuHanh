...
<script>
    ...
    statistical.forEach(values => {
        ...
        data1.push(values['Hoàn thành trước hạn']);
    });
    // console.log(departmentName);
    updateDateBarChart(departmentName, data1);
    ...
    $('#priority-filter').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                barChart.data.datasets[0].data = data1;
                barChart.update();
            },
        });
    });
    //============================================= Bar chart =============================================//
    function updateDateBarChart(departmentName, data1) {
        console.log('te');
