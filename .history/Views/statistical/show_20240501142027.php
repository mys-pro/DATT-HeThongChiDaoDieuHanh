        ...
        $.ajax({
            ...
            success: function(response) {
                for (var i = 0; i < response.length; i++) {
                    ...
                    var tasks = response[i]['Tổng công việc'];
                    var onTime = response[i]['Hoàn thành đúng hạn'];
                    // và các thông tin khác tùy vào cấu trúc của dữ liệu

                    // Sử dụng dữ liệu để hiển thị hoặc xử lý trong ứng dụng của bạn
                    console.log(department, tasks, onTime);
                }
            },
        });
    });
