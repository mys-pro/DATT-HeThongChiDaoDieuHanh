<div class="content w-100 px-2 overflow-hidden">
    ...
    <div class="row g-0">
        <div class="col d-flex">
            <ul class="filter-list list-unstyled m-0 p-2 d-flex position-relative">
                ...
                <li id="date-item" class="filter-item me-2 d-none">
                    <div class="input-group">
                        <input id="date-input" type="text" class="form-control text-secondary border-end-0 bg-transparent border-secondary" placeholder="Thời gian" aria-label="date-filter">
            ...
            <button type="button" class="btn btn-primary btn-filter m-2 h-100">Áp dụng</button>
        </div>
    </div>
