...
<script>
    ...
    var DepartmentName = [];
    var data1 = [];
    statistical.forEach(value => {
        DepartmentName.push(value['DepartmentName']);
        data1.push(value['Hoàn thành trước hạn']);
    });

    barChart(DepartmentName, data1);
    ...
    //============================================= Bar chart =============================================//
    function barChart(DepartmentName, data1) {
        ...
        var barChat = new Chart($('#barChart'), barConfig);
    }
    //============================================= Doughnut Chart =============================================//
    <?php
    $result = "";
