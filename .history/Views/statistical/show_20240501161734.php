...
<script>
    //============================================= Bar chart =============================================//
    var statistical = <?php echo json_encode($statistical) ?>;
    var departmentName = [];
    var data0 = [];
    var data1 = [];
    var data2 = [];
    ...
    statistical.forEach(values => {
        ...
        data0.push(values['Hoàn thành trước hạn']);
        data1.push(values['Hoàn thành đúng hạn']);
        data2.push(values['Hoàn thành trễ hạn']);
        data3.push(values['Chờ duyệt']);
        data4.push(values['Chưa hoàn thành']);
        data5.push(values['Quá hạn']);
    });
    ...
    $('#priority-filter').change(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                barChart.data.datasets.forEach(item => {
                    item.data = data[count];
                    count++;
                });

                barChart.data.datasets[0].data = data0;
                barChart.data.datasets[1].data = data0;
                barChart.data.datasets[2].data = data0;
                barChart.data.datasets[3].data = data0;
                barChart.data.datasets[4].data = data0;
                barChart.data.datasets[5].data = data0;
                barChart.update();
            },
        });
    });
