            ...
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        ...
                        <th class="bg-body-secondary text-center" scope="col" style="min-width: 100px">Ngày giao việc</th>
                        <th class="bg-body-secondary text-center" scope="col" style="min-width: 100px">Hạn hoàn thành</th>
