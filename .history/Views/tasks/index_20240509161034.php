            ...
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        ...
                        <th class="bg-body-secondary text-start" scope="col" style="min-width: 200px">Tình trạng</th>
                        <th class="bg-body-secondary text-center" scope="col" style="min-width: 150px">Ngày giao việc</th>
                        <th class="bg-body-secondary text-center" scope="col" style="min-width: 150px">Hạn hoàn thành</th>
                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Tên công việc" class="text-start text-truncate"><?= $value["TaskName"] ?>12321safddfsdfsdf sdf sdf sdf sdf sdf sdf sdf asdf asdf asdf asdf sadf sdf sadf sdf sadf à asdf sdf sadf sadf á</td>
