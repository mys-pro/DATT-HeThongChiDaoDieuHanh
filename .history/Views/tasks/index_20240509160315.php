                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Tên công việc" class="text-start text-truncate" style="max-width: 50px;"><?= $value["TaskName"] ?>12321safddfsdfsdf sdf sdf sdf sdf sdf sdf sdf asdf asdf asdf asdf sadf sdf sadf sdf sadf à asdf sdf sadf sadf á</td>
