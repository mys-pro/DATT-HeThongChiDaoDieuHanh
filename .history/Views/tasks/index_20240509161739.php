            ...
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                ...
                <tbody>
                    <?php foreach ($taskList as $value) : ?>
                        <tr>
                            <td data-cell="Tên công việc" style="text-align: justify;"><?= $value["TaskName"] ?>ádfasdfasdfasdfasdfasdfasfasfasfasfasdfasfasfasfasfasfsadfafasdfasdfasdfasdfasdfasdf</td>
