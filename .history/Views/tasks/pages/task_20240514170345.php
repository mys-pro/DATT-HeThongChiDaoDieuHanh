<div class="content w-100 px-2 overflow-hidden">
    ...
    <div class="modal fade" id="Task" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <select name="" id="TaskPerformers" class="z-3">
                            <option value="1">Bùi Mình Trường</option>
                            <option value="2">Nguyễn Tuấn Tài</option>
                            <option value="3">Danh Ngọc Thái</option>
                        </select>
