    ...
    <script>
        $(document).ready(function() {
            ...
            function matchCustom(params, data) {
                ...
                // Check if the current item is an optgroup
                if (data.children) {
                    var match = false;
                    // Iterate through each child (option) in the optgroup
                    ...
                    // If any child option matches, return the optgroup
                    if (match) {
                        return data;
                    }
                }

                // Check if the current item (option or optgroup label) contains the search term
