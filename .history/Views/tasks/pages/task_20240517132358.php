    ...
    <script>
        $(document).ready(function() {
            ...
            $('#send-task-btn').click(function() {
                ...
                viewModal.find("#deadline-task").val();
                descriptionEditor.getData();
                viewModal.find("#TaskPerformers").val();
                viewModal.find("#deadline-TaskPerformers").val();
                viewModal.find("#TaskReview").val();
                viewModal.find("#deadline-TaskReview").val();
            })
