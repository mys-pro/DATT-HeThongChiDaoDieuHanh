        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="AssignedBy d-flex align-items-center">
                        <span class="me-2 fw-semibold">Người giao việc: </span>
                        <div class="AssignedBy-info d-flex align-items-center">
                            ...
                            <div class="AssignedBy-name">
                                <p class="m-0 fw-semibold text-primaty"><?= $_SESSION["UserInfo"][0]["FullName"] ?></p>
