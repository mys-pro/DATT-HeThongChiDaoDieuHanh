            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select class="form-select">
                        <option value="1"><i class="bi bi-star-fill"></i> Option 1</option>
                        <option value="2"><i class="bi bi-heart-fill"></i> Option 2</option>
                        <option value="3"><i class="bi bi-globe2"></i> Option 3</option>
