...
<div class="content w-100 px-2 overflow-hidden">
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="fw-semibold ms-1 mb-1"><i class="bi bi-person-fill me-2 text-secondary"></i>Người thực hiện</label>
                    <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="deadline-input form-control rounded-0 p-0 ps-2 mx-2" min="1" max ="10" value="1" id="deadline-TaskReview">
                            <span>ngày</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var deadlineTask = $('#deadline-task').val();
            var deadlineTaskPerformers = $('#deadline-TaskPerformers').val();
            var deadlineTaskReview = $('#deadline-TaskReview').val();

            deadlineTaskPerformers.attr("max", deadlineTask + deadlineTaskReview);
