        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="textarea-task form-control border-0 mb-2 fw-semibold overflow-hidden" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
                    ...
                    <div class="Description mb-2">
                        ...
                        <textarea class="textarea-task form-control border-0 my-2 fw-semibold"></textarea>
                    </div>
                </div>
