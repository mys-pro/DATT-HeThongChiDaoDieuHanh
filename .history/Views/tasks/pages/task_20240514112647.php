        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea oninput="autoResize(this)" class="textarea-task form-control border-0 mb-2 fw-semibold" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
