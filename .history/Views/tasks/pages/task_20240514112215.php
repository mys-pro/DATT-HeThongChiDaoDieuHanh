        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="textarea-task form-control border-0 my-2 fw-semibold" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
                    ...
                    <div class="Description mb-2">
                        <button class="border-0 bg-transparent text-primary"><i class="bi bi-text-left me-2"></i> Nhập mô tả</button>
                        <textarea class="textarea-task form-control border-0 my-2 fw-semibold" id="Description-content"></textarea>
                    </div>
                </div>
