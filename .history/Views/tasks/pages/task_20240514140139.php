        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="TaskPerformers-dropdown" class="dropdown d-flex align-items-center">
                        <label for="TaskPerformers-dropdown-toggle" class="fw-semibold ms-1"><i class="bi bi-person-fill me-2"></i>Phòng ban/Người thực hiện</label>
                        <button id="TaskPerformers-dropdown-toggle" data-value="1" class="btn bg-transparent ou dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-square-fill text-secondary opacity-50 me-2"></i> Thấp
                        </button>
                        <ul class="dropdown-menu">
                            <li><button data-value="1" class="dropdown-item" type="button">
