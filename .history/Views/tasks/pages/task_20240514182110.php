    ...
    <script>
        $(document).ready(function() {
            ...
            function formatState(state) {
                ...
                var $state = $(
                    '<div class="d-flex align-items-center"><img src="' + $(state.element).data('avatar') + '" class="rounded-circle" style="width: 36px; height: 36px;" /> ' +
                    '<div><p class="m-0 fw-semibold">' + $(state.element).data('title') + '</p><br>' +
                    '<p class="m-0 text-secondary">' + $(state.element).data('role') + ' - ' + $(state.element).data('company') + '</p></div></div>'
                );
