        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="priority-dropdown" class="dropdown d-flex">
                        <label for="">Độ ưu tiên:</label>
                        <button data-value="1" class="btn bg-transparent ou dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-square-fill text-secondary me-2"></i> Thấp
                        </button>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <button data-value="2" class="dropdown-item" type="button">
                                    <i class="bi bi-square-fill text-primary me-2"></i> Vừa
                                </button>
                            </li>
                            <li>
                                <button data-value="3" class="dropdown-item" type="button">
                                    <i class="bi bi-square-fill text-warning me-2"></i> Cao
                                </button>
                            </li>
                        </ul>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#priority-dropdown .dropdown-item').click(function() {
                var text = $(this).html();
                $('#priority-dropdown .dropdown-toggle').html(text);
            });
        })
    </script>
</div>