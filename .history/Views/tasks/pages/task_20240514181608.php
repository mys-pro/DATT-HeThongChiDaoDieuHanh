        ...
        $(document).ready(function() {
            ...
            function formatState(state) {
                ...
                var $state = $(
                    ...
                    '<div class="AssignedBy-info d-flex align-items-center"><img src="' + $(state.element).data('avatar') + '" class="rounded-circle" style="width: 36px; height: 36px;" /> ' +
                    '<strong>' + $(state.element).data('title') + '</strong><br>' +
                    '<small>' + $(state.element).data('role') + ' - ' + $(state.element).data('company') + '</small></div>'
                );
