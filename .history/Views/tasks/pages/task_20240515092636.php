        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="fw-semibold ms-1"><i class="bi bi-person-fill me-2 text-secondary"></i>Người thực hiện</label>
                    <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <label class="fw-semibold ms-1"><i class="bi bi-person-fill-check me-2 text-secondary"></i>Người thẩm định</label>
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <select name="" id="TaskReview" class="border-0">
                            <option value="null" data-title="Chọn người thực hiện" data-icon="bi-person-fill-check" disabled selected hidden>Chọn người thẩm định</option>
                            <optgroup label="Văn phòng">
                                <option value="1" data-title="Nguyễn Thị Hương" data-role="Tổng cục trưởng" data-company="MISA TaskGov" data-avatar="https://example.com/avatar1.png">Nguyễn Thị Hương</option>
                            </optgroup>
