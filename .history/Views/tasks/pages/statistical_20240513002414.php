    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-filter-statistical').click(function() {
                ...
                var url = window.location.origin + window.location.pathname + "?priority=all&date=" + date;
                if(priority != 0 && priority != null) {
                    url = window.location.origin + window.location.pathname + "?priority=" + priority + "&date=" + date;
                }
