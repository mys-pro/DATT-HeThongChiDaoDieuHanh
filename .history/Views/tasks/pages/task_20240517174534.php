                ...
                <div class="modal-body">
                    ...
                    <div class="attachments">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action border-0">An item</li>
                            <li class="list-group-item list-group-item-action border-0">A second item</li>
                            <li class="list-group-item list-group-item-action border-0">A third item</li>
                            <li class="list-group-item list-group-item-action border-0">A fourth item</li>
