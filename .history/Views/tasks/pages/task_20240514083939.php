                ...
                <div class="modal-body">
                    <div id="priority-dropdown" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><button data-value="1" class="dropdown-item" type="button">Action</button></li>
                            <li><button data-value="2" class="dropdown-item" type="button">Another action</button></li>
                            <li><button data-value="3" class="dropdown-item" type="button">Something else here</button></li>
                        </ul>
                    </div>
                </div>
