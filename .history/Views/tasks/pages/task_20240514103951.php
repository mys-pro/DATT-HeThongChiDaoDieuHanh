        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="form-control border-0 fs-5 my-2" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
                    <div class="AssignedBy d-flex">
                        <span class="me-2">Người giao việc: </span>
                        <div class="AssignedBy-info d-flex">
                            <img class="rounded-circle" src="data:image/jpeg;base64,<?= base64_encode($_SESSION["UserInfo"][0]["Avatar"]) ?>" alt="" width="32px" height="32px">
                            <div>
                                <span class="d-block"><?= $_SESSION["UserInfo"][0]["FullName"] ?></span>
                                <span class=""><?= $_SESSION["UserInfo"][0]["PositionName"] ?> - <?= $_SESSION["UserInfo"][0]["DepartmentName"] ?></span>
                            </div>
                        </div>
                    </div>
                </div>
