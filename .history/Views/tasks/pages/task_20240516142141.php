                    ...
                    <div class="d-md-flex align-items-center justify-content-between mb-2">
                        <div id="priority-dropdown" class="dropdown d-flex align-items-center">
                            ...
                            <select name="" id="view-task-priority" class="ms-2 border-0">
                                <option value="1" data-title="Thấp" data-icon="bi bi-square-fill text-secondary" color-icon="bg-secondary">Thấp</option>
                                <option value="2" data-title="Vừa" data-icon="bi bi-square-fill" color-icon="bg-primary">Vừa</option>
                                <option value="3" data-title="Cao" data-icon="bi bi-square-fill" color-icon="bg-danger">Cao</option>
                            </select>
                        </div>
