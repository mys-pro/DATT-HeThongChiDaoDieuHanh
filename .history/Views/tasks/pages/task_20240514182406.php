        ...
        $(document).ready(function() {
            ...
            function formatState(state) {
                ...
                var $state = $(
                    ...
                    '<p class="m-0 fw-semibold" style="font-size: 14px">' + $(state.element).data('title') + '</p><br>' +
                    '<p class="m-0 text-secondary" style="font-size: 12px">' + $(state.element).data('role') + ' - ' + $(state.element).data('company') + '</p></span>'
                );
