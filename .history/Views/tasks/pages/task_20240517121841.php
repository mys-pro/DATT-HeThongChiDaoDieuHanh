        ...
        $(document).ready(function() {
            ...
            $('#table-data > tbody > tr').click(function() {
                ...
                if (assignedBy != assignedByUserId) {
                    ...
                    viewModal.find('#view-task-priority').data('select2').enable(false);
                    viewModal.find("#deadline-task").prop('disabled', true);

                } else if (assignedBy == assignedByUserId){
                    viewModal.find("#delete-task-btn").removeClass("d-none");
                    viewModal.find('#view-task-name').prop('disabled', false);
                    viewModal.find('#view-task-priority').data('select2').enable(true);
