            ...
            <table id="table-data" class="table table-hover border shadow-sm mb-2">
                ...
                <tbody>
                    <?php foreach ($data['taskList'] as $index => $value) : ?>
                        <tr data-id="<?= $value["TaskID"] ?>" assigned-by="<?= $value["AssignedBy"] ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="textarea-task form-control rounded-0 mb-2 bg-transparent" id="view-task-name" rows="1"></textarea>
                    <div class="d-md-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="deadline-input form-control rounded-0 p-0 ps-2 mx-2 bg-transparent" min="2" value="2" id="deadline-task">
                            <span>ngày</span>
                        </div>
                    </div>
                    ...
                    <div class="d-md-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="deadline-input form-control rounded-0 p-0 ps-2 mx-2 bg-transparent" min="1" value="1" id="deadline-TaskPerformers">
                            <span>ngày</span>
                        </div>
                    </div>
                    ...
                    <div class="d-md-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="deadline-input form-control rounded-0 p-0 ps-2 mx-2 bg-transparent" min="1" value="1" id="deadline-TaskReview">
                            <span>ngày</span>
                        </div>
                    </div>
                    ...
                    <div class="attachments">
                        ...
                        <ul id="attachments-list" class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3" data-value="1">
                                <span class="file-name fw-medium">
                                    file.pdf <br>
                                    <span class="text-secondary fw-normal">16.0 KB</span>
                                </span>
                                <button class="remove-file-btn btn btn-white border-0" data-value="1"><i class="bi bi-x-lg"></i></button>
                            </li>

                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3" data-value="2">
                                <span class="file-name fw-medium">
                                    file.pdf <br>
                                    <span class="text-secondary fw-normal">16.0 KB</span>
                                </span>
                                <button class="remove-file-btn btn btn-white border-0" data-value="2"><i class="bi bi-x-lg"></i></button>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-file').change(function() {
                ...
                var newItem = '<li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3 data-value="0">' +
                    '<span class="file-name fw-medium" >' +
                        fileName + '<br>' +
                        '<span class = "text-secondary fw-normal" >' + fileSize + ' KB</span>' +
                    '</span>' +
                    '<button class="remove-file-btn btn btn-white border-0" data-value="0"><i class="bi bi-x-lg"></i></button>' +
                '</li>';
                $('#attachments-list').prepend(newItem);
            });

            $("#remove-file-btn").click(function(){
                var value = $(this).attr("data-value");
                var li = '#add-file li[data-value=""]'
                $('#add-file li[data-value=""]').remove();
            });
