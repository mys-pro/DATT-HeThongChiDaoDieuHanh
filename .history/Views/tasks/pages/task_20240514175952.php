<div class="content w-100 px-2 overflow-hidden">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#TaskPerformers').on('select2:select', function(e) {
                $(this).next('.select2-container').css('width', 'auto');
            });

            // Tự động điều chỉnh chiều rộng khi mở dropdown
            $('#TaskPerformers').on('select2:open', function(e) {
                $(this).next('.select2-container').css('width', 'auto');
            });
