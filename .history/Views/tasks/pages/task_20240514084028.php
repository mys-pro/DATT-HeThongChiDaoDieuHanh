            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="priority-dropdown" class="dropdown">
                        <button data-value="1" class="btn bg-transparent ou dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-square-fill"></i> Thấp
                        </button>
                        <ul class="dropdown-menu">
                            <li><button data-value="1" class="dropdown-item" type="button">Thấp</button></li>
                            <li><button data-value="2" class="dropdown-item" type="button">Vừa</button></li>
                            <li><button data-value="3" class="dropdown-item" type="button">Cao</button></li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#priority-dropdown .dropdown-item').click(function() {
                var text = $(this).text();
                $('#priority-dropdown .dropdown-toggle').text(text);
            });
        })
    </script>
</div>