            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="TaskPerformers-dropdown" class="dropdown">
                        <label class="fw-semibold ms-1 me-2"><i class="bi bi-person-fill me-2"></i>Phòng ban/Người thực hiện</label><br>
                        <button id="TaskPerformers-dropdown-toggle" data-value="null" class="btn bg-transparent ou dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="bi bi-person-circle fs-4 me-2"></i> Chọn người thực hiện
                        </button>
                        <ul class="dropdown-menu">
                            <li><button data-value="1" class="dropdown-item" type="button">
                                    <i class="bi bi-square-fill text-secondary opacity-50 me-2"></i> Thấp
