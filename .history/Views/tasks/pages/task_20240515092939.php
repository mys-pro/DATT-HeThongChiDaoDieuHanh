        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label class="fw-semibold ms-1"><i class="bi bi-person-fill me-2 text-secondary mb-1"></i>Người thực hiện</label>
                    <div class="d-flex align-items-center justify-content-between mb-2">
                    ...
                    <label class="fw-semibold ms-1"><i class="bi bi-person-fill-check me-2 text-secondary mb-1"></i>Người thẩm định</label>
                    <div class="d-flex align-items-center justify-content-between mb-2">
