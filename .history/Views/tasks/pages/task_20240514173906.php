        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <select name="" id="TaskPerformers">
                            <option data-title="Chọn người thực hiện" data-icon="bi-person-fill">Chọn người thực hiện</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            function formatState(state) {
                ...
                // Tùy chỉnh cho tùy chọn đầu tiên
                if (state.element.value == "0") {
                    var $state = $(
                        '<span><i class="bi ' + $(state.element).data('icon') + ' ms-3 me-2 text-secondary border border-2 rounded-circle d-flex align-items-center justify-content-center"></i> ' +
                        $(state.element).data('title') + '</span>'
                    );
                    return $state;
                }

                // Tùy chỉnh cho các tùy chọn khác
                var $state = $(
                    '<span><img src="' + $(state.element).data('avatar') + '" class="img-circle" style="width: 30px; height: 30px;" /> ' +
            ...
            var $state = $(
                '<span><img src="' + $(state.element).data('avatar') + '" class="rounded-circle" style="width: 30px; height: 30px;" /> ' +
                '<strong>' + $(state.element).data('title') + '</strong><br>' +
                '<small>' + $(state.element).data('role') + ' - ' + $(state.element).data('company') + '</small></span>'
            );
