        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="save-task-btn" type="button" class="btn btn-primary" assigned-by="0"><i class="bi bi-send me-2"></i>Gửi</button>
                </div>
            </div>
        </div>
    </div>
        ...
        $(document).ready(function() {
            ...
            $('#table-data > tbody > tr').click(function() {
                ...
                if (assignedBy != assignedByUserId) {
                    viewModal.find("#delete-task-btn").addClass("d-none");
                    ...
                    viewModal.find("#TaskReview").val(data["userReviewer"]).prop("disabled", true);
                    viewModal.find("#deadline-TaskReview").val(data["deadlineReviewer"]);


                } else {
                    viewModal.find("#delete-task-btn").removeClass("d-none");
                    ...
                    viewModal.find("#TaskReview").val(data["userReviewer"]).prop("disabled", false);
