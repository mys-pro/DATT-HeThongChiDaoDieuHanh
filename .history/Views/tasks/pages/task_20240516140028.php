    ...
    <div class="modal fade" id="view-task-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="task-name" class="mb-1">Tên công việc</label>
                    <textarea class="textarea-task form-control border-0 mb-2 fw-semibold fs-5" id="task-name" rows="1">Công việc 1</textarea>
