...
<div class="content w-100 px-2 overflow-hidden">
    ...
    <script>
        $(document).ready(function() {
            ...
            function toastNotify(toast, type, message) {
                var icon = '';
                switch(type) {
                    case 'success': {
            ...
            $('#table-data > tbody > tr').click(function() {
                ...
                $.ajax({
                    ...
                    error: function() {
                        toastNotify($("#toast-notify"), 'danger', "Lỗi hệ thống vui lòng thử lại sau.");
                    }
                });
            });
            ...
            $('#add-task-submit').click(function() {
                ...
                if (taskName.trim() === "") {
                    toastNotify($("#toast-notify"), 'warning', "Vui lòng nhập tên công việc.");
                } else {
