            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="priority-dropdown" class="dropdown d-flex align-items-center mb-2">
                        <label for="priority-dropdown-toggle" class="fw-semibold">Độ ưu tiên:</label>
                    ...
                    <label for="task-name" class="fw-semibold">Tên công việc</label>
                    <textarea class="textarea-task form-control border-0 rounded-0 mb-2" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
                    ...
                    <div class="Description mb-2">
                        <label class="border-0 bg-transparent mb-2"><i class="bi bi-text-left me-2"></i>Mô tả</label>
                        <textarea class="textarea-task form-control" id="Description-content" rows="1"></textarea>
                    </div>
                </div>
