        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <rows= onkeyup="textAreaAdjust(this)" class="form-control border-0" id="task-name" placeholder="Nhập tên công việc"></rows="1" textarea>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var autoResize = function() {
                ...
                $textarea.css('height', $textarea[0].scrollHeight + 'px !important');
            };
