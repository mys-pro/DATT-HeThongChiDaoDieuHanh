...
<div class="content w-100 px-2 overflow-hidden">
    ...
    <div class="modal fade" id="view-task-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 me-2" id="staticBackdropLabel">Công việc</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="d-md-flex align-items-center justify-content-between mb-2">
                        <div id="priority-dropdown" class="dropdown d-flex align-items-center">
                            <label for="priority-dropdown-toggle me-2">Độ ưu tiên:</label>
                            <select name="" id="view-task-priority" class="border-0">
                                <option value="1" icon="bi bi-square-fill" color-icon="bg-secondary">Thấp</option>
                                <option value="2" icon="bi bi-square-fill" color-icon="bg-primary">Vừa</option>
                                <option value="3" icon="bi bi-square-fill" color-icon="bg-danger">Cao</option>
                            </select>
                        </div>
