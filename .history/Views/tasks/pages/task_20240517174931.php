                ...
                <div class="modal-body">
                    ...
                    <div class="attachments">
                        <div class="attachments-title ms-1 mb-1 d-flex align-items-center justify-content-between">
                            ...
                            <label for="" class="btn btn-secondary py-1">Thêm</label>
                        </div>

                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3 list-group-item-secondary">
                                <span class="file-name">file.pdf</span>
                                <span class="file-size">16.0 KB</span>
                            </li>

                            <li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3 list-group-item-info">
                                <span class="file-name">file.pdf</span>
                                <span class="file-size">16.0 KB</span>
                            </li>
                        </ul>
