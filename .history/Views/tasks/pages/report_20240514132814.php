<div class="content w-100 px-2 overflow-hidden">
    ...
    <div class="row g-0">
        <div class="col d-flex">
                ...
                <li id="date-item" class="filter-item me-2 d-none">
                    <div class="input-group">
                        <input id="date-input" type="text"
                            ...
                            placeholder="Thời gian" aria-label="date-input">
            ...
            <button id="Export-report" type="button" class="btn btn-secondary m-2 ms-0" data-bs-toggle="tooltip"
                data-bs-placement="bottom" data-bs-title="Xuất file">
            ...
            <table id="table-data" class="table table-hover border shadow-sm mb-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-cell="Thẩm định" class="text-center"><?php if ($value['Reviewer'] == 1) echo "x" ?>
                        </td>
