        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-sm-down">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="textarea-task form-control border-0 rounded-0 mb-2 fw-semibold" id="task-name" placeholder="Nhập tên công việc" rows="1"></textarea>
                    ...
                    <div class="Description mb-2">
                        <button id="Description-btn" class="border-0 bg-transparent mb-2 text-primary"><i class="bi bi-text-left me-2"></i> Nhập mô tả</button>
                        <textarea class="textarea-task form-control d-none" id="Description-content" rows="7"></textarea>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#Description-btn').click(function() {
                if($("#Description-content").html() === NULL) {
                    $("#Description-content").toggleClass('d-none');
                }
            });

            if ($("#Description-content").css("display") !== "none" || $("#Description-content").html() !== NULL) {
                ClassicEditor
