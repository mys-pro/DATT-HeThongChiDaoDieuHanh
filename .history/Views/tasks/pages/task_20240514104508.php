                ...
                <div class="modal-body">
                    ...
                    <div class="AssignedBy d-flex">
                        ...
                        <div class="AssignedBy-info d-flex">
                            <img class="rounded-circle" src="data:image/jpeg;base64,<?= base64_encode($_SESSION["UserInfo"][0]["Avatar"]) ?>" alt="" width="36px" height="36px">
                            <div class="AssignedBy-name">
                                <p class="m-0"><?= $_SESSION["UserInfo"][0]["FullName"] ?></p>
                                <p class="m-0"><?= $_SESSION["UserInfo"][0]["PositionName"] ?> - UBND</p>
                            </div>
                        </div>
                    </div>
                </div>
