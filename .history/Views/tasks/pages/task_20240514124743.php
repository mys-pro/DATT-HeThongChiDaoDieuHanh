<div class="content w-100 px-2 overflow-hidden">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="Description mb-2">
                        <button id="Description-btn" class="border-0 bg-transparent text-primary"><i class="bi bi-text-left me-2"></i>Nhập mô tả</button>
                        <div class="d-none">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (dataValue == "Hoàn thành trước hạn") {
                $(this).addClass("bg-primary text-primary");
            } else if (dataValue == "Hoàn thành") {
                $(this).addClass("bg-success text-success");
            } else if (dataValue == "Hoàn thành trễ hạn") {
                $(this).addClass("bg-warning text-warning");
            } else if (dataValue == "Chờ duyệt") {
                $(this).addClass("bg-info text-info");
            } else if (dataValue == "Trễ hạn") {
                $(this).addClass("bg-danger text-danger");
            } else {
                $(this).addClass("bg-secondary text-secondary");
            }
