                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="form-control rounded-0 p-0 ps-2 mx-2" min="1" value="1" id="deadline-task">
                            <span>ngày</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div id="TaskPerformers-dropdown" class="dropdown">
                            ...
                            <button id="TaskPerformers-dropdown-toggle" data-value="null" class="btn bg-transparent ou dropdown-toggle border-0 d-flex align-items-center" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi bi-person-fill ms-3 me-2 text-secondary border border-2 rounded-circle d-flex align-items-center justify-content-center"></i> 
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="number" class="dealine-input form-control rounded-0 p-0 ps-2 mx-2" min="1" value="1" id="deadline-TaskPerformers">
                            <span>ngày</span>
                        </div>
                    </div>
                </div>
