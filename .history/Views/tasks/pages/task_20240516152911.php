                ...
                <div class="modal-body">
                    ...
                    <div class="AssignedBy mb-2 d-flex align-items-center">
                        ...
                        <div class="AssignedBy-info d-flex align-items-center">
                            <img class="rounded-circle me-2" src="data:image/jpeg;base64,<?= NULL ?>" alt="" width="36px" height="36px">
                            <div class="AssignedBy-name">
                                <p class="m-0 text-primary">Name</p>
                                <p class="m-0 text-secondary">Position - Department</p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function customStatusView() {
                var statusTask = $('#view-task-modal').filter(".badge").attr('data-value');
            ...
            function updateModalView(data = []) {
                ...
                viewModal.find('.badge').text(data["statusTaskName"]);
