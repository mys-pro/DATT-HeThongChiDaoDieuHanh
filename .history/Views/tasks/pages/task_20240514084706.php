            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="priority-dropdown" class="dropdown d-flex align-items-center">
                        ...
                        <button id="prioritydropdown-toggle" data-value="1" class="btn bg-transparent ou dropdown-toggle border-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
