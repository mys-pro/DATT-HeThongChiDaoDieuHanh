        ...
        $(document).ready(function() {
            ...
            function matchCustom(params, data) {
                ...
                if (data.children) {
                    ...
                    // Lặp qua từng option trong optgroup
                    $.each(data.children, function(i, child) {
                        // Kiểm tra nếu văn bản của option chứa thuật ngữ tìm kiếm
                    ...
                    // Nếu bất kỳ option nào khớp, trả về optgroup với các option đã lọc
                    if (match) {
                ...
                // Kiểm tra nếu phần tử hiện tại (option hoặc nhãn optgroup) chứa thuật ngữ tìm kiếm
                if (data.text.toUpperCase().indexOf(searchTerm) > -1) {
                    return data;
                }

                // Nếu không có kết quả khớp, trả về null
                return null;
            }
