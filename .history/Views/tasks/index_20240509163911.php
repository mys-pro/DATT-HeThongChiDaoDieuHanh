                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Tên công việc" class="text-start text-task-name">
                                <span class="text-task-content text-truncate d-inline-block" style="max-width: 180px;">
                                    <?= $value["TaskName"] ?>12321safddfsdfsdf sdf sdf sdf sdf sdf sdf sdf asdf asdf asdf asdf sadf sdf sadf sdf sadf à asdf sdf sadf sadf á
                                </span>
                            </td>
