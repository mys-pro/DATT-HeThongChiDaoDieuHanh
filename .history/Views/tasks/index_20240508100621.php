                ...
                <tbody>
                    <?php foreach($taskList as $index => $value): ?>
                        <tr>
                            ...
                            <td data-cell="Tình trạng" class="text-center"><?php if($value["AssignedBy"] == $_SESSION["UserInfo"][0]["UserID"]) echo $value["Status"]; else echo $value["TP_Status"]; ?></td>
                            <td data-cell="Ngày giao việc" class="text-center"><?= $value["DateCreated"] ?>
                            </td>
