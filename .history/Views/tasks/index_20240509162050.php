            ...
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        ...
                        <th class="bg-body-secondary text-start" scope="col" style="max-width: 150px;">Tên công việc</th>
                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Tên công việc" class="text-task-name text-start text-truncate" style="max-width: 150px;"><?= $value["TaskName"] ?>12321safddfsdfsdf sdf sdf sdf sdf sdf sdf sdf asdf asdf asdf asdf sadf sdf sadf sdf sadf à asdf sdf sadf sadf á</td>
