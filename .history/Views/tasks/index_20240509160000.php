            ...
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        ...
                        <th class="bg-body-secondary text-start" scope="col" width="100px">Tên công việc</th>
                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Tên công việc" class="text-start text-truncate" width="100px><?= $value["TaskName"] ?>12321safddfsdfsdf sdf sdf sdf sdf sdf sdf sdf </td>
