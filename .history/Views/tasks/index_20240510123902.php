            ...
            <table id="table-data" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        ...
                        <th class="bg-body-secondary text-center" scope="col">Người giao</th>
                ...
                <tbody>
                    <?php foreach ($taskList as $index => $value) : ?>
                        <tr>
                            ...
                            <td data-cell="Người giao" class="text-center">
                                <div class = "AssignedBy text-start d-flex ">
                                    <img class="rounded-circle" src="data:image/jpeg;base64,<?= base64_encode($value["Avatar"]) ?>" alt="" width="32px" height="32px">
                                    <div class="AssignedBy-info ms-2">
                                        <span class=""><?= $value["FullName"] ?></span><br>
                                        <span class=""><?= $value["Position"] ?> - <?= $value["Department"] ?></span>
                                    </div>
                                </div>
                            </td>
