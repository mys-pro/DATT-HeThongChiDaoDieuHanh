    ...
    <div class="row g-0">
        <div class="col">
            <table id="table-data" class="table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        <th class="bg-light-subtle text-center" scope="col">STT</th>
                        <th class="bg-light-subtle text-start" scope="col">Tên công việc</th>
                        <th class="bg-light-subtle text-start" scope="col">Tình trạng</th>
                        <th class="bg-light-subtle text-start" scope="col">Người giao</th>
                        <th class="bg-light-subtle text-center" scope="col">Hạn hoàn thành</th>
                        <th class="bg-light-subtle text-center" scope="col" style="min-width: 100px">Tiến độ</th>
                    </tr>
                </thead>
                <tbody>
