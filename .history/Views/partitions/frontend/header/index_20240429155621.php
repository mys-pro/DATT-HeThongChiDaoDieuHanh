...
<head>
    ...
    <link rel="icon" href="http://localhost/DATT-HeThongChiDaoDieuHanh/public/Image/icon.png" />
    <title>Hệ thống chỉ đạo điều hành</title>
    <link rel="stylesheet" href="http://localhost/DATT-HeThongChiDaoDieuHanh/public/css/material_blue.css">
    <link rel="stylesheet" href="http://localhost/DATT-HeThongChiDaoDieuHanh/bootstrap/bootstrap-icons-1.11.3/font/bootstrap-icons.min.css">
    <link rel="stylesheet" href="http://localhost/DATT-HeThongChiDaoDieuHanh/bootstrap/bootstrap-5.3.3-dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://localhost/DATT-HeThongChiDaoDieuHanh/public/css/Styles.css">
</head>
        ...
        <header class="app__header position-fixed top-0 start-0 end-0 z-3">
            <nav class="header__navbar navbar">
                <div class="container-xxl">
                    ...
                    <a href="#" class="header__navbar-logo navbar-brand p-0 d-flex me-auto overflow-hidden">
                        <img class="header__navbar-img" src="http://localhost/DATT-HeThongChiDaoDieuHanh/public/Image/Logo.png" alt="" width="40px"
                            height="40px">
                                ...
                                <div class="row row-cols-3 g-2">
                                    <div class="col">
                                        <a href="#"
                                            ...
                                            <img src="http://localhost/DATT-HeThongChiDaoDieuHanh/public/Image/task-icon.png" alt="" width="36px" height="36px">
                                            Công việc
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a href="#"
                                            class="text-decoration-none text-secondary d-flex flex-column align-items-center px-1 py-2 rounded-3">
                                            <img src="http://localhost/DATT-HeThongChiDaoDieuHanh/public/Image/admin-icon.png" alt="" width="36px" height="36px">
                                            Hệ thống
                                        </a>
                                    </div>
                                </div>
