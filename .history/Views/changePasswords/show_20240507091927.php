...
<script>
    $(document).ready(function() {
        var leavingPage = false; // Biến để đánh dấu khi người dùng rời khỏi trang
            ...
            // Xử lý khi người dùng chuyển trang hoặc đóng tab
            $(document).on('click', 'a', function() {
                leavingPage = true; // Đặt biến khi người dùng chuyển trang
            });
