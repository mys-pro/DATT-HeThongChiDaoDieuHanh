        ...
        $('.btn-submit').click(function() {
            ...
            if (inputPassword1 == '') {
                ...
                if (!valid.test(inputPassword1)) {
                    $('.wrong-account').text('Mật khẩu không hợp lệ. Yêu cầu ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường, số và ký tự đặc biệt.');
                    $('.wrong-account').css('text-align', 'left !important');
                } else {
