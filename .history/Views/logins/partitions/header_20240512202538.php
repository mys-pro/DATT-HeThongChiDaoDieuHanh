...
<body>
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div id="login-toast" class="toast align-items-center border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body d-flex align-items-center">
                    <i class="toast-body__icon bi bi-check fs-2 lh-1"></i>
