...
<head>
    ...
    <link rel="stylesheet" href="<?php echo getWebRoot() ?>/public/css/material_blue.css">
                ...
                <div class="container-xxl">
                    ...
                    <ul class="header__navbar-list-right list-inline p-0 m-0 d-flex align-items-center">
                        ...
                        <li class="header__navbar-item ms-2 position-relative">
                            ...
                            <div class="list-apps z-3 bg-white rounded-3 position-absolute p-2 border border-1 hide">
                                <div class="row row-cols-3 g-2">
                                    <div class="col">
                                        <a href="#" class="text-decoration-none text-secondary d-flex flex-column align-items-center px-1 py-2 rounded-3">
                        ...
                        <li class="header__navbar-item ms-2">
                            <div class="header__navbar-avatar bg-success bg-gradient rounded-circle w-100 h-100 text-white d-flex justify-content-center align-items-center">
                                TN
                            </div>
                        </li>
                    </ul>
