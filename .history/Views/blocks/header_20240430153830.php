                        ...
                        <li class="header__navbar-item ms-2 position-relative">
                            ...
                            <div class="list-apps z-3 bg-white rounded-3 position-absolute p-2 border border-1 hide">
                                <div class="row row-cols-3 g-2">
                                    <div class="col">
                                        <a href="<?= getWebRoot() ?>/task/task" class="text-decoration-none text-secondary d-flex flex-column align-items-center px-1 py-2 rounded-3">
                                            <img src="<?= getWebRoot() ?>/public/Image/task-icon.png" alt="" width="36px" height="36px">
                                            Công việc
                                        </a>
                                    </div>
                                    <div class="col">
                                        <a href="<?= getWebRoot() ?>/kb/phong-ban" class="text-decoration-none text-secondary d-flex flex-column align-items-center px-1 py-2 rounded-3">
