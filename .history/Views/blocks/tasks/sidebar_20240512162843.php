        ...
        <li class="sidebar__content-item mb-2">
            ...
            <ul class="sidebar__dropdown collapse list-inline text-secondary <?= getDropdownItem($active, 'task') ?>" id="sidebarToggleExternalContent">
                <li class="sidebar__dropdown-item mt-2">
                    <a href="" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center <?php if(!isset($_REQUEST["v"]) || $_REQUEST["v"] == "tat-ca") echo "active" ?>">
                        Tất cả
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                ...
                <li class="sidebar__dropdown-item mt-2">
                    <a href="<?= getWebRoot() ?>/ac/cong-viec?v=cho-phe-duyet" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center <?php if(isset($_REQUEST["v"]) && $_REQUEST["v"] == "cho-phe-duyet") echo "active" ?>">
                        Chờ phê duyệt
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="<?= getWebRoot() ?>/ac/cong-viec?v=tu-choi-phe-duyet" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center <?php if(isset($_REQUEST["v"]) && $_REQUEST["v"] == "tu-choi-phe-duyet") echo "active" ?>">
                        Từ chối phê duyệt
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
