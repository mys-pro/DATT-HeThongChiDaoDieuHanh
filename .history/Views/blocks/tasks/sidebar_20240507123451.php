<div class="sidebar shadow-sm offcanvas offcanvas-start p-3 d-flex flex-column border-0" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <ul class="sidebar__content-list list-unstyled p-0 m-0">
        ...
        <li class="sidebar__content-item mb-2">
            <a href="" class="rounded-3 text-decoration-none text-secondary d-block collapse position-relative <?= getActiveMenu($active, 'task') ?>" data-bs-toggle="collapse" data-bs-target="#sidebarToggleExternalContent">
                <i class="bi bi-clipboard2-check me-3"></i>
                <span>Công việc</span>
                <i class="bi bi-caret-down-fill"></i>
            </a>

            <ul class="sidebar__dropdown collapse list-inline text-secondary show" id="sidebarToggleExternalContent">
                <li class="sidebar__dropdown-item mt-2">
                    <a href="#" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center active">
                        Tất cả
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
