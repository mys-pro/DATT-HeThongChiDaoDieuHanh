<div class="sidebar shadow-sm offcanvas offcanvas-start p-3 d-flex flex-column border-0" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <ul class="sidebar__content-list list-unstyled p-0 m-0">
        ...
        <li class="sidebar__content-item mb-2">
            <a href="<?= getWebRoot() ?>/ac/cong-viec" class="rounded-3 text-decoration-none text-secondary d-block collapsed position-relative <?= getActiveMenu($active, 'task') ?>" data-bs-toggle="collapse" data-bs-target="#sidebarToggleExternalContent">
            ...
            <ul class="sidebar__dropdown collapse list-inline text-secondary" id="sidebarToggleExternalContent">
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=tat-ca" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Tất cả
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=chua-hoan-thanh" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Chưa hoàn thành
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=hoan-tat" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Hoàn tất
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=cho-phe-duyet" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Chờ phê duyệt
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=tu-choi-phe-duyet" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Từ chối phê duyệt
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
                    <a href="?v=du-thao" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Dự thảo
                    </a>
                </li>
            </ul>
