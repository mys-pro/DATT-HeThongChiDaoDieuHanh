<div class="sidebar shadow-sm offcanvas offcanvas-start p-3 d-flex flex-column border-0" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
    ...
    <ul class="sidebar__content-list list-unstyled p-0 m-0">
        <li class="sidebar__content-item mb-2">
            <a href="<?= getWebRoot() ?>/task/statistical" class="rounded-3 text-decoration-none text-secondary d-block <?php if($active == "statistical") echo "active"; ?>">
        ...
        <li class="sidebar__content-item mb-2">
            <a href="<?= getWebRoot() ?>/task/report" class="rounded-3 text-decoration-none text-secondary d-block <?php if($active == "report") echo "active"; ?>">
        ...
        <li class="sidebar__content-item mb-2">
            ...
            <ul class="sidebar__dropdown collapse list-inline text-secondary" id="sidebarToggleExternalContent">
                <li class="sidebar__dropdown-item mt-2">
                    <a href="<?= getWebRoot() ?>/task/task" class="text-secondary text-decoration-none rounded-3 d-block d-flex justify-content-between align-items-center">
                        Tất cả
                    </a>
                </li>
                <li class="sidebar__dropdown-item mt-2">
