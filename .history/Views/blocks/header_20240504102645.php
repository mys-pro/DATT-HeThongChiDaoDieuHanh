...
<body>
    <?php if($welcome): ?>
        <div class="toast-container position-fixed bottom-0 end-0 p-3">
            <div id="welcomeToast" class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="toast-header">
                    <img src="<?= getWebRoot() ?>/Public/Image/icon.png" class="rounded me-2" alt="..." width="20px" height="20px">
                    <strong class="me-auto text-white">Hệ thống</strong>
