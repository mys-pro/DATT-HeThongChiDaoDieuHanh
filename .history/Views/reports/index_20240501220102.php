    ...
    <div class="row g-0">
        <div class="col">
            <table class="table table-hover border shadow-sm">
                <thead>
                    <tr>
                        <th class="bg-light-subtle" scope="col">#</th>
                        <th class="bg-light-subtle" scope="col">First</th>
                        <th class="bg-light-subtle" scope="col">Last</th>
                        <th class="bg-light-subtle" scope="col">Handle</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
