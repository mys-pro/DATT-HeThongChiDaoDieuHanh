...
$pdf->MultiCell(10, 10, 'STTSSSSSSSS', 1, 'C');
$pdf->Cell(10, 10, 'Tên công việc', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'Đơn vị thực hiện', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'Thẩm định', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'Thời gian bắt đầu', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'Thời gian dự kiến', 1, 0, 'C', 1);
$pdf->Cell(40, 10, 'Trạng thái', 1, 0, 'C', 1);
