<div class="content w-100 px-2 overflow-hidden">
    ...
    <div class="row g-0">
        <div class="col">
            <table class="table-report table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                ...
                <tfoot>
                    <tr>
                        <td colspan="2" class="text-center" scope="col">Tổng</td>
                        <td class="text-center" scope="col">Tổng công việc</td>
                        <td class="text-center" scope="col">Hoàn tdành trước hạn</td>
                        <td class="text-center" scope="col">Hoàn tdành đúng hạn</td>
                        <td class="text-center" scope="col">Hoàn tdành trễ hạn</td>
                        <td class="text-center" scope="col">Chờ duyệt</td>
                        <td class="text-center" scope="col">Chưa hoàn tdành</td>
                        <td class="text-center" scope="col">Quá hạn</td>
                    </tr>
                </tfoot>
            </table>
        </div>
