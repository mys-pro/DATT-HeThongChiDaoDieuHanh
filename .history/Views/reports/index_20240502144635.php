        ...
        <div class="col">
            <table id="table-report" class="table table-hover border shadow-sm mb-2">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td data-cell="" class="text-center"><?= $count ?></td>
                            <td data-cell="" class="text-center"><?= $value['TaskName'] ?></td>
                            <td data-cell="" class="text-center"><?= $value['DepartmentName'] ?></td>
                            <td data-cell="" class="text-center"><?php if($value['Reviewer'] == 1) echo "x" ?></td>
                            <td data-cell="" class="text-center"><?= $value['DateCreated'] ?></td>
                            <td data-cell="" class="text-center"><?= $value['ExpectedDate'] ?></td>
                            <td data-cell="" class="text-center"><?= $value['Status'] ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
