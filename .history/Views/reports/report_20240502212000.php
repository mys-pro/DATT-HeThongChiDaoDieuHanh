...
$pdf->SetLeftMargin(10);
$pdf->SetRightMargin(10);
$pdf->MultiCell(10, 10, 'STT', 1, 'C', 1);
$pdf->SetXY(20, -10);
$pdf->MultiCell(10, 10, 'Tên công việc', 1,'C');
$pdf->MultiCell(40, 10, 'Đơn vị thực hiện', 1, 'C');
$pdf->MultiCell(40, 10, 'Thẩm định', 1, 'C');
$pdf->MultiCell(40, 10, 'Thời gian bắt đầu', 1, 'C');
$pdf->MultiCell(40, 10, 'Thời gian dự kiến', 1, 'C');
$pdf->MultiCell(40, 10, 'Trạng thái', 1, 'C');
