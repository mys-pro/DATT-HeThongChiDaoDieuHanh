    ...
    <div class="row g-0">
        <div class="col">
            <table class="table-report table table-hover border shadow-sm mb-2">
                <thead>
                    <tr>
                        <th class="bg-body-secondary text-center" style="vertical-align: middle" scope="col">STT</th>
                        <th class="bg-body-secondary text-center justi" scope="col">Tên phòng ban</th>
