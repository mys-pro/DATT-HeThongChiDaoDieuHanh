    ...
    public function viewTask()
    {
        if (isset($_POST["idTask"])) {
            ...
            foreach ($document as $value) {
                $documentList .= '<li class="list-group-item list-group-item-action border-0 d-flex align-items-center justify-content-between mb-2 rounded-3" data-value="'. $value[""] .'">
