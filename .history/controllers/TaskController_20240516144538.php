...
class TaskController extends BaseController
{
    ...
    public function viewTask($id) {
        $sql = "SELECT t.TaskName, t.Description, t.Priority, t.Progress, t.Status, t.Deadline, tp.UserID, tp.Deadline, tp.Progress, tp.Reviewer, tp.Status, tp.Comment FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID JOIN Users u ON tp.UserID = u.UserID WHERE t.TaskID = 1";
    }
