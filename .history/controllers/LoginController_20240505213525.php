...
class LoginController extends BaseController
{
    ...
    {
        $UserID = $this->userModel->getIDbySha1('c1dfd96eea8cc2b62785275bca38ac261256e278');
        $time = $this->userModel->userInfo($UserID)[0]["DateUpdate"];
        echo $this->countSecond($time);
        ...
        // $time = $this->userModel->userInfo($UserID)[0]["DateUpdate"];
        // if ($forgotToken == null || $forgotToken == "" || $this->countSecond($time) >= 30) {
        //     header("Location:" . getWebRoot());
        //     exit;
        // }
