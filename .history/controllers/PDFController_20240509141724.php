...
class PDFController extends BaseController
{
    ...
    private function downloadReport($title, $data)
    {
        ...
        <thead>
            <tr>
                <th scope="col" width="42px">STT</th>
                <th scope="col" width="131px">Tên công việc</th>
                <th scope="col" width="224px">Đơn vị thực hiện</th>
                <th scope="col" width="108px">Thẩm định</th>
                <th scope="col" width="166px">Thời gian bắt đầu</th>
                <th scope="col" width="165px">Thời gian dự kiến</th>
                <th scope="col" width="191px">Trạng thái</th>
            </tr>
        </thead>
        <tbody>
        ';
