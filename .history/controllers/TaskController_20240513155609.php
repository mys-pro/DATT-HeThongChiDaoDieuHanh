...
class TaskController extends BaseController
{
    ...
    {
        if (isset($_REQUEST['priority']) && isset($_REQUEST['date'])) {
            echo json_encode($this->taskModel->statistical($_REQUEST['priority'], $_REQUEST['date'], $_REQUEST['dateStart'], $_REQUEST['dateEnd']));
            exit();
        } else if () {
