...
class PDFController extends BaseController
{
    ...
    private function downloadReport($title, $data)
    {
        ...
        $headerCellHeightRatio = 0.8;
        $rowCellHeightRatio = 0.6;

        $html = '
        <table>
        <thead>
            <tr style="height: ' . (10 * $headerCellHeightRatio) . 'px;">>
                <th scope="col" width="30px" style="vertical-align: middle;">STT</th>
                <th scope="col" width="128.5px" style="vertical-align: middle;">Tên công việc</th>
                <th scope="col" width="100px" style="vertical-align: middle;">Đơn vị thực hiện</th>
                <th scope="col" width="50px" style="vertical-align: middle;">Thẩm định</th>
                <th scope="col" width="80px" style="vertical-align: middle;">Thời gian bắt đầu</th>
                <th scope="col" width="80px" style="vertical-align: middle;">Thời gian dự kiến</th>
                <th scope="col" width="70px" style="vertical-align: middle;">Trạng thái</th>
            </tr>
        </thead>
        <tbody>
        ';
        ...
        foreach ($data as $value) {
            ...
            $html .= '
                <tr style="height: ' . (10 * $rowCellHeightRatio) . 'px;">
