...
class TaskController extends BaseController
{
    ...
    public function addTask()
    {
        ...
        $this->taskModel->insertData("Tasks", ['NULL', '${askName}', 'NULL', "'1'", "'0'", "'Dự thảo'", 'current_timestamp()', "'2'", 'NULL', 'NULL', "'2'"]);
        if (isset($_POST["taskName"])) {
            $taskName = $_POST["taskName"];
            $this->taskModel->insertData("Tasks", ['NULL', '${taskName}', 'NULL', "'1'", "'0'", "'Dự thảo'", 'current_timestamp()', "'2'", 'NULL', 'NULL', "'2'"]);
        }
    }
