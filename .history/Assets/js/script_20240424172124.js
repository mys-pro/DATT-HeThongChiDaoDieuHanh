...
$("#date-type-filter").change(function () {   
    if ($("#date-type-filter").val() == "year") {
        flatpickr("#date-type-filter", {
            dateFormat: "Y",
        });
    } else if ($("#date-type-filter").val() == "month") {
        flatpickr("#date-type-filter", {
            dateFormat: "M",
        });
    }
...
// new Chart($('#general-chart'), barConfig);
