...
class UserModel extends BaseModel
{
    ...
    {
        $sql = "SELECT Avatar, FullName, Gmail, PhoneNumber, u.Status, PositionName, DepartmentName FROM Users u JOIN Positions p ON u.PositionID = p.PositionID LEFT JOIN Departments d ON u.DepartmentID = d.DepartmentID WHERE UserID = ${id}";
        return $this->getData($sql);
    }
