...
class TaskModel extends BaseModel
{
    ...
    public function viewTask($id) {
        $sql = "SELECT t.TaskName, t.Description, t.Priority, t.Progress AS ProgressTask, t.Status AS StatusTask, t.Deadline AS DeadlineTask, tp.UserID, tp.Deadline AS DeadlineTaskPerformers, tp.Progress AS ProgressTaskPerformers, tp.Reviewer, tp.Status AS StatusTaskPerformers, tp.Comment FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID JOIN Users u ON tp.UserID = u.UserID WHERE t.TaskID = ${id}";
        return $this->getData($sql);
    }
}
