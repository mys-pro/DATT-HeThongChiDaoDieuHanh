...
class TaskModel extends BaseModel
{
    ...
    public function updateTask($data = [])
    {
        ...
        //     return  $this->addData("TaskPerformers", ["'{$data["taskID"]}'", "'{$data["taskPerformers"]}'", "'{$currentDate}'", "'{$data["deadlineTaskPerformers"]}'", "''", "'0'", "'0'", "'Chưa thực hiện'", "''"]);

            return $this->addData("TaskPerformers", ["'{$data["taskID"]}'", "'{$data["taskReview"]}'", "NULL", "'{$data["deadlineReview"]}'", "''", "'0'", "'1'", "'Chưa thực hiện'", "''"]);
