...
class TaskModel extends BaseModel
{
    ...
    public function updateTask($id, $data = [])
    {
        ...
        try {
            ...
            $this->addData("TaskPerformers", INSERT INTO `TaskPerformers` (`TaskID`, `UserID`, `DateStart`, `Deadline`, `CompletionDate`, `Progress`, `Reviewer`, `Status`, `Comment`) VALUES ('22', '3', NULL, '2', '', '0', '1', 'Chưa thực hiện', '');)
        } catch (Exception $e) {
            mysqli_rollback($this->connect);
            return false;
        }
