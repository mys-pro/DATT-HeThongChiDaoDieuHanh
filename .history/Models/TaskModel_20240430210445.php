...
class TaskModel extends BaseModel
{
    ...
    public function statisticalByMonth($priority = 1)
    {
        $sql = "SELECT d.DepartmentName,
                ...
                FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID JOIN Users u ON tp.UserID = u.UserID RIGHT JOIN Departments d ON u.DepartmentID = d.DepartmentID AND YEAR(tp.DateStart) = YEAR(CURRENT_DATE) AND t.Priority = 2
