...
class TaskModel extends BaseModel
{
    ...
    public function viewTask($id)
    {
        ...
        FROM Tasks t JOIN Users u ON t.AssignedBy = u.UserID JOIN Positions p ON u.PositionID = p.PositionID LEFT JOIN Departments d ON u.DepartmentID = d.DepartmentID LEFT JOIN TaskPerformers tp ON t.TaskID = tp.TaskID WHERE t.TaskID = ${id} GROUP BY t.TaskID ASC";
        return $this->getData($sql);
    }
