...
class TaskModel extends BaseModel
{
    ...
    public function getTask() {
        $sql = "SELECT DISTINCT t.*, tp.UserID AS TP_UserID, tp.DateStart AS TP_DateStart, tp.Deadline AS TP_Deadline, tp.CompletionDate AS TP_CompletionDate, tp.Progress AS TP_Progress, tp.Reviewer, tp.Status AS TP_Status, tp.Comment FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID";
        return $this->getData($sql);
    }
}
