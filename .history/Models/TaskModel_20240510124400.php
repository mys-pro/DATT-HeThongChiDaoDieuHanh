...
class TaskModel extends BaseModel
{
    ...
    {
        $sql = "SELECT t.TaskName, t.AssignedBy, tp.* FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID WHERE tp.TaskID = ${TaskID} AND UserID = ${UserID}";
        return $this->getData($sql);
    }
    ...
    public function getDepartmentByID($id) {
        $sql = "SELECT * FROM Departments WHERE DepartmentID = ${id = NULL : 0 ? $id}";
        return $this->getData($sql);
    }
}
