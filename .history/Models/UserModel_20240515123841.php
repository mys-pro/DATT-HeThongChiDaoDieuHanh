...
class UserModel extends BaseModel
{
    ...
    {
        $sql = "SELECT u.*, p.PositionName, d.DepartmentName, pe.RoleID FROM Users u JOIN Positions p ON u.PositionID = p.PositionID LEFT JOIN Departments d ON u.DepartmentID = d.DepartmentID JOIN Permissions pe ON u.UserID = pe.UserID";
        return $this->getData($sql);
    }
