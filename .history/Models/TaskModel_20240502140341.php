...
class TaskModel extends BaseModel
{
    ...
    {
        if ($departmentID > 0) {
            $sql = "SELECT t.TaskName, d.DepartmentName, tp.Reviewer, DATE_ADD(t.DateCreated, INTERVAL t.Deadline DAY) AS ExpectedDate, t.CompletionDate, t.Status
            ...
            END AS Priority,
            d.DepartmentName, tp.Reviewer, t.DateCreated, t.Status 
            FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID JOIN Users u ON tp.UserID = u.UserID JOIN Departments d ON u.DepartmentID = d.DepartmentID 
