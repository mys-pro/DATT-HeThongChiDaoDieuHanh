...
class UserModel extends BaseModel
{
    ...
    {
        $sql = "SELECT Avatar, FullName, Gmail, PhoneNumber, PositionName, DepartmentName FROM Users u JOIN Positions p ON u.PositionID = p.PositionID JOIN Departments d ON u.DepartmentID = d.DepartmentID WHERE UserID = ${id}";
        return $this->getData($sql);
    }
