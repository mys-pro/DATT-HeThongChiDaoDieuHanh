...
class TaskModel extends BaseModel
{
    ...
    public function getTaskPerformersByTask($TaskID = 0) {
        $sql = "SELECT t.TaskName, tp.* FROM Tasks t JOIN TaskPerformers tp ON t.TaskID = tp.TaskID WHERE UserID = ${TaskID}";
        return $this->getData($sql);
    }
}
